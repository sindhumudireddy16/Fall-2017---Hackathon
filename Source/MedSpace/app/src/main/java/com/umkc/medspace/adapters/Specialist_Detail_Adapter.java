...
public class Specialist_Detail_Adapter extends RecyclerView.Adapter<Specialist_Detail_Adapter.MyViewHolder> {
    ...
    public Specialist_Detail_Adapter(Context context, List<Details_data> Hospital_data, String specialist) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_details_adapter, parent, false);
